    ...
    <div>
      ...
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          <a href="#signin" className={styles.btn}>Sign In</a>
      ...
      <section id="features" className={`${styles.section} ${styles.bgLight}`}>
        ...
        <div className={styles.featuresGrid}>
          <div className={styles.featureCard}>
            ...
            <p>Gain actionable insights into your transactions with AI-driven analytics.</p>
          </div>
          <div className={styles.featureCard}>
            <Image src="/feature2.png" alt="Feature 2" width={100} height={100} />
            <h4>Secure Payments</h4>
            <p>Experience industry-standard encryption and security for all transactions.</p>
          </div>
          <div className={styles.featureCard}>
            <Image src="/feature3.png" alt="Feature 3" width={100} height={100} />
            <h4>Seamless Integration</h4>
            <p>Connect AI-Transact easily with your existing tools and platforms.</p>
          </div>
        </div>
      </section>
